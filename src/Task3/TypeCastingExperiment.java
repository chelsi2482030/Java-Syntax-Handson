...
public class TypeCastingExperiment {
    public static void main(String[] args) {
        ...
        int convertedlnt = (int) preciseValue;

        System.out.println("\nExplicit Casting (no data loss):");
        System.out.println("double: " + preciseValue + "> int: " + convertedlnt);

        //3. Explicit Casting - Dengan Data Loss
        double decimalValue = 123.789;
        int truncatedlnt = (int) decimalValue;

        System.out.println("\\nExplicit Casting (with data loss):");
        System.out.println("double: " + decimalValue + "-> int: " + truncatedlnt);

        //4. Overflow Example
        int largelnt = 300;
        byte overflowByte = (byte) largelnt;

        System.out.println("\\nOverflow Example: ");
        System.out.println("int: " + largelnt + "-> byte: " + overflowByte);
        ...
        //Analisi kapan terjadi data loss dan kapan tidak
